    ...
    >
      <div className="mx-auto max-w-site px-8 max-[600px]:px-[22px]">
        ...
        <a
          ...
          className="animate-reveal animate-reveal-delay-3 -mt-[4px] inline-flex items-center gap-2 border px-[26px] py-[13px] text-[14.5px] font-medium text-cream transition-colors hover:border-cream"
